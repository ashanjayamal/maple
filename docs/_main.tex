...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-18}{}\label{exr:unnamed-chunk-18}Performs the indicated computations.
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-19}{}\label{exr:unnamed-chunk-19}Determine the given matrices are invertible. If they are, compute the inverse.
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-20}{}\label{exr:unnamed-chunk-20}Compute the matrix,\(\begin{bmatrix}
  x & x^2 \\x^2 & x^3
  \end{bmatrix}\)
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-21}{}\label{exr:unnamed-chunk-21}Which of the following matrices are skew-symmetric?
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-22}{}\label{exr:unnamed-chunk-22}Convert the following matrix in to an upper triangular matrix.
\[\begin{bmatrix} 2 & 3 & -1 \\ -3 & -2 & 1 \\  0& 1 & 1\end{bmatrix}\]
\end{exercise}

\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-23}{}\label{exr:unnamed-chunk-23}Convert the following matrices into a identity matrix.
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-26}{}\label{exr:unnamed-chunk-26}Solve the following system of equations.
\[
\begin{array}{ccccccc}
x_1  &+& 2x_2 &+& 3x_3 &= 9 \\
2x_1 &-& x_2  &+& x_3  &= 8 \\
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-28}{}\label{exm:unnamed-chunk-28}Method of integration by parts to compute \(\int x \cos(x)\)
\end{example}
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-29}{}\label{exm:unnamed-chunk-29}Evaluate \(\int 4 \cos(\sin(x))  dx\) using the substitution, \(u=\cos(x)\) .
\end{example}
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-34}{}\label{exm:unnamed-chunk-34}Find the area under the curve \(x^2\sin(x)\)
\end{example}
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-35}{}\label{exm:unnamed-chunk-35}Find the area bounded by the curves \(−x^2 +4x + 6\) and \(\frac{x}{3}+2\)
\end{example}
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-36}{}\label{exm:unnamed-chunk-36}Find the area of the region enclosed between the two curves \(f(x)=2x+5\) and \(g(x)=x^2+2\) from \(x=0\) to \(x=6\).
\end{example}
