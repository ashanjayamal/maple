...
2. Create a function to check if two sets are equal. (Hint: use the subset property twice.)

3. Create a function to find the symmetric difference of two sets, \(A \bigtriangleup B\). 

   Test functions 2 and 3 with:
   * \(A = \{1, 3, 5, 7\}\)
   * \(B = \{2, 4, 5, 6\}\)
   * \(P = \{1, 2, 3, 5, 6, 7\}\)
   * \(Q = \{2, 4, 5, 6\}\)
