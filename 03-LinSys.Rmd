...
|Example 1|\[\begin{align}x - 3y &=-3\\2x + y &= 8\end{align}\]|\[\begin{align}x - 3y &= - 3\\x -y &=3\end{align}\]|\[\begin{align}x - 3y &= - 3\\2x + 6y &= -6 \end{align}\]|
||![](figures/Lesson 5/1.jpg)|![](figures/Lesson 5/2.jpg)|![](figures/Lesson 5/3.jpg)|
|Example 2|\[\begin{align}x+y+z&=2\\
6x-4y+5z&=1\\
5x+2y+2z&=3\end{align}\]|\[\begin{align}x-3y+z&=4\\-y-4z&=7\\2y+8z&=24 \end{align}\]|\[\begin{align}2x+y-3z&=0\\
4x+2y-6z&=0\\
x-y+z&=0\end{align}\]|
